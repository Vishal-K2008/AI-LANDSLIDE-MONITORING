          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="text-xs text-slate-400 font-semibold">{location.district}, {location.state}</span>
              ...
              <h3 className="text-xl font-bold font-display text-white mt-0.5">{location.name}</h3>
            </div>
          </div>
        ...
        <div className="p-6 space-y-6 overflow-y-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <div className="p-4 rounded-2xl bg-blue-50/60 border border-blue-100">
              ...
              <p className="text-2xl font-bold font-display text-slate-900">{envData ? envData.rainfall_mm : 82} mm</p>
              <p className="text-[11px] text-slate-500 mt-0.5">Precipitation rate</p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-teal-50/60 border border-teal-100">
              ...
              <p className="text-2xl font-bold font-display text-slate-900">{envData ? envData.soil_moisture_pct : 78}%</p>
              <p className="text-[11px] text-slate-500 mt-0.5">Volumetric saturation</p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-amber-50/60 border border-amber-100">
              ...
              <p className="text-2xl font-bold font-display text-slate-900">{location.slope_deg}°</p>
              <p className="text-[11px] text-slate-500 mt-0.5">Elevation: {location.elevation_m}m</p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-slate-100 border border-slate-200">
              ...
              <p className="text-2xl font-bold font-display text-slate-900">{envData ? envData.temp_c : 18}°C</p>
              <p className="text-[11px] text-slate-500 mt-0.5">{envData?.weather_condition || 'Overcast Rain'}</p>
            </div>
          </div>
