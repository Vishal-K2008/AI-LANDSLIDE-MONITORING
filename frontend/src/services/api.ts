...
const MOCK_ALERTS: EarlyWarningAlert[] = [
  {
    id: 1,
    location_id: 2,
    location_name: 'Gangtok - Nathula Pass Highway',
    alert_level: 'CRITICAL',
    title: '🚨 CRITICAL LANDSLIDE WARNING - Gangtok Nathula Pass',
    description: 'Automated AI sensors detected severe saturation and storm intensity at Gangtok. Extreme risk of soil slip within next 6 hours.',
    reason: 'Rainfall: 110.0 mm | Soil Moisture: 86.5% | Slope: 38.0°',
  ...
  },
  {
    id: 2,
    location_id: 1,
    location_name: 'Shillong - Sohra (Cherrapunji) Highway',
    alert_level: 'HIGH',
    title: '⚠️ HIGH LANDSLIDE RISK - Shillong Sohra Highway',
    description: 'Heavy precipitation and elevated pore-water pressure detected. High probability of embankment failure.',
    reason: 'Rainfall: 125.5 mm | Soil Moisture: 88.0% | Slope: 36.5°',
